...
Shader "SH_MiniVenus"
{
	Properties
	{
		...
		_Color("Color", Color) = (1,0.8438681,0.5235849,0)
		_Color1("Color", Color) = (1,0.8438681,0.5235849,0)
		...
		_Cloud_Movement("Cloud_Movement", Vector) = (0.72,0.02,0,0)
	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float2 texCoord15 = IN.ase_texcoord9.xy * _Tiling_Clouds_Moving + float2( 0,4.56 );
				float2 panner17 = ( 0.4 * _Time.y * _Cloud_Movement + texCoord15);
				float2 temp_cast_0 = (_NoiseScale1).xx;
				float2 texCoord6 = IN.ase_texcoord9.xy * temp_cast_0 + float2( 0,0 );
				float4 temp_output_14_0 = ( _Color * ( _EmissionStrength * tex2D( _Noise63, panner17 ) * tex2D( _TextureSample1, texCoord6 ) ) * _Color1 );
		...
		Pass
		{
			...
			)
			{
				...
				float2 texCoord15 = IN.ase_texcoord8.xy * _Tiling_Clouds_Moving + float2( 0,4.56 );
				float2 panner17 = ( 0.4 * _Time.y * _Cloud_Movement + texCoord15);
				float2 temp_cast_0 = (_NoiseScale1).xx;
				float2 texCoord6 = IN.ase_texcoord8.xy * temp_cast_0 + float2( 0,0 );
				float4 temp_output_14_0 = ( _Color * ( _EmissionStrength * tex2D( _Noise63, panner17 ) * tex2D( _TextureSample1, texCoord6 ) ) * _Color1 );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float2 texCoord15 = IN.ase_texcoord3.xy * _Tiling_Clouds_Moving + float2( 0,4.56 );
				float2 panner17 = ( 0.4 * _Time.y * _Cloud_Movement + texCoord15);
				float2 temp_cast_0 = (_NoiseScale1).xx;
...
Node;AmplifyShaderEditor.ColorNode;11;-1211.228,-209.5329;Inherit;False;Property;_Color;Color;2;0;Create;True;0;0;0;False;0;False;1,0.8438681,0.5235849,0;0.945098,0.8585377,0.6833059,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;7;-1913.337,480.5836;Inherit;False;Property;_NoiseScale1;Noise Scale;1;0;Create;True;0;0;0;False;0;False;1;2.58;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;8;-1508.08,452.0506;Inherit;True;Property;_TextureSample1;Noise;0;0;Create;False;0;0;0;False;0;False;-1;ef2d075270368e145ab4d78fbc5565bc;ef2d075270368e145ab4d78fbc5565bc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;6;-1745.396,459.1165;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;12;-1434.287,33.77645;Inherit;False;Property;_EmissionStrength;Emission Strength;4;0;Create;True;0;0;0;False;0;False;0.5;3.19;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-1113.507,130.3221;Inherit;False;3;3;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-871.9085,-64.77292;Inherit;False;3;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;25;-876.2332,415.2058;Inherit;False;Property;_Color1;Color;3;0;Create;True;0;0;0;False;0;False;1,0.8438681,0.5235849,0;0.9568627,0.9568627,0.9568627,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;19;-2569.892,272.6089;Inherit;False;Property;_Cloud_Movement;Cloud_Movement;7;0;Create;True;0;0;0;False;0;False;0.72,0.02;0.03,0.05;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TextureCoordinatesNode;15;-2399.702,114.0589;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,4.56;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PannerNode;17;-2144.159,177.9026;Inherit;False;3;0;FLOAT2;0,0;False;2;FLOAT2;0,0;False;1;FLOAT;0.4;False;1;FLOAT2;0
Node;AmplifyShaderEditor.SamplerNode;18;-1943.18,145.7186;Inherit;True;Property;_Noise63;Noise63;6;0;Create;True;0;0;0;False;0;False;-1;ff023cd47bb523a4cbc64a19883de5d9;f67b0caf301647746a1428d747eac20f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;16;-2640.581,135.8818;Inherit;False;Property;_Tiling_Clouds_Moving;Tiling_Clouds_Moving;5;0;Create;True;0;0;0;False;0;False;3,3;14.51,6;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;ASEMaterialInspector;0;4;SH_MiniVenus;ed95fe726fd7b4644bb42f4d1ddd2bcd;True;ForwardBase;0;1;ForwardBase;18;False;True;0;1;False;;0;False;;0;1;False;;0;False;;True;0;False;;0;False;;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;False;True;3;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;DisableBatching=False=DisableBatching;True;2;False;0;False;True;1;5;False;;10;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=ForwardBase;False;False;0;;0;0;Standard;40;Workflow,InvertActionOnDeselection;1;0;Surface;1;638346932555232029;  Blend;0;0;  Refraction Model;0;0;  Dither Shadows;1;0;Two Sided;0;638346595560126665;Deferred Pass;1;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;0;638346598339487619;Ambient Light;1;0;Meta Pass;1;0;Add Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Fwd Specular Highlights Toggle;0;0;Fwd Reflections Toggle;0;0;Disable Batching;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;6;False;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.RangedFloatNode;26;-298.3052,199.7251;Inherit;False;Property;_Opacity;Opacity;8;0;Create;True;0;0;0;False;0;False;0.5;0.1;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FD344837C8C92CC4BBD6EB611538D3C1643C6816