...
Shader "SH_Snow"
{
	...
	SubShader
	{
		...
		float3 PerturbNormal107_g92( float3 surf_pos, float3 surf_norm, float height, float scale )
		{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 surf_pos107_g92 = ase_worldPos;
			float3 ase_worldNormal = WorldNormalVector( i, float3( 0, 0, 1 ) );
			float3 surf_norm107_g92 = ase_worldNormal;
			float3 ase_vertex3Pos = mul( unity_WorldToObject, float4( i.worldPos , 1 ) );
			float cameraDepthFade30 = (( i.eyeDepth -_ProjectionParams.y - 0.0 ) / _DetailFadeDistance);
			float temp_output_32_0 = saturate( ( 1.0 - cameraDepthFade30 ) );
			float height107_g92 = ( (-1.0 + (( tex2D( _Detail, ( (ase_vertex3Pos).xz / _DetailTextureScale ) ).b * _SandTextureInfluence ) - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) * temp_output_32_0 );
			float scale107_g92 = 1.0;
			float3 localPerturbNormal107_g92 = PerturbNormal107_g92( surf_pos107_g92 , surf_norm107_g92 , height107_g92 , scale107_g92 );
			float3 ase_worldTangent = WorldNormalVector( i, float3( 1, 0, 0 ) );
			float3 ase_worldBitangent = WorldNormalVector( i, float3( 0, 1, 0 ) );
			float3x3 ase_worldToTangent = float3x3( ase_worldTangent, ase_worldBitangent, ase_worldNormal );
			float3 worldToTangentDir42_g92 = mul( ase_worldToTangent, localPerturbNormal107_g92);
...
Node;AmplifyShaderEditor.RangedFloatNode;29;-4235.303,-379.718;Inherit;False;Property;_DetailFadeDistance;DetailFadeDistance;5;0;Create;True;0;0;0;False;0;False;0;229;0;1000;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;66;-3975.685,-655.4942;Inherit;False;Property;_SandTextureInfluence;SandTextureInfluence;8;0;Create;True;0;0;0;False;0;False;0;1.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;17;-2930.859,-1386.53;Inherit;False;Property;_Albedo;Albedo;0;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;-2224.925,-974.7393;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;SH_Snow;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-3931.314,-68.13049;Inherit;False;Property;_Roughness;Roughness;7;0;Create;True;0;0;0;False;0;False;0;0.42;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=66FF9E1C68C44B5AEAAA4A802363E92818C32BDD