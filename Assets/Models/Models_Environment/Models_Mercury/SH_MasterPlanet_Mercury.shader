...
Shader "SH_MasterPlanet_Mercury"
{
	Properties
	{
		...
		_Tiling_noise("Tiling_noise", Vector) = (3,3,0,0)
		...
		_SINmax("SIN max", Float) = 0
		_Noise97("Noise97", 2D) = "white" {}
	...
	SubShader
	{
		...
		uniform sampler2D _Noise97;
		uniform float2 _Tiling_noise;
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float clampResult351 = clamp( ( _SinTime.w + 1.0 ) , 0.0 , _SINmax );
			float4 temp_cast_1 = (_power_Water).xxxx;
			float4 lerpResult302 = lerp( _Color_Water , _Color_Water1 , ( pow( ( tex2D( _Noise77, uv_TexCoord307 ) * saturate( clampResult351 ) ) , temp_cast_1 ) * _Multiply_Water ));
			...
			float2 uv_TexCoord364 = i.uv_texcoord * _Tiling_noise;
			float4 lerpResult361 = lerp( lerpResult320 , _colornoise , ( tex2D( _Noise97, uv_TexCoord364 ) * _NoiseMultiply ));
			o.Albedo = lerpResult361.rgb;
...
Node;AmplifyShaderEditor.ColorNode;227;3448.591,-1067.771;Inherit;False;Property;_Color_Water;Color_Water;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.8039216,0.682353,0.509804,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;230;3863.869,-556.3705;Inherit;False;Property;_Tiling_Planet;Tiling_Planet;8;0;Create;True;0;0;0;False;0;False;0,0;4.6,1.78;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;298;3458.219,-882.1747;Inherit;False;Property;_Color_Water1;Color_Water;5;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.5158182,0.25,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;296;3544.754,-2402.415;Inherit;False;Property;_Color_Sand1;Color_Sand;7;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.8867924,0.7222081,0.497775,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;283;3523.053,-2607.239;Inherit;False;Property;_Color_Sand;Color_Sand;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.735849,0.6121827,0.4338732,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;286;2924.367,-1754.382;Inherit;False;Property;_Tiling_Sand;Tiling_Sand;9;0;Create;True;0;0;0;False;0;False;3,3;9.94,4.9;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;317;3734.337,-1344.263;Inherit;False;Property;_Sand_Cloud_intensity;Sand_Cloud_intensity;21;0;Create;True;0;0;0;False;0;False;2;15.99;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;310;3961.067,-2103.122;Inherit;False;Property;_Multiply_Sand;Multiply_Sand;20;0;Create;True;0;0;0;False;0;False;3.36;1.9;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;312;3569.401,-2073.619;Inherit;False;Property;_power_Sand;power_Sand;15;0;Create;True;0;0;0;False;0;False;10;5.73;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;333;3969.319,-92.37196;Inherit;True;Property;_Noise37;Noise37;23;0;Create;True;0;0;0;False;0;False;-1;ef2d075270368e145ab4d78fbc5565bc;ef2d075270368e145ab4d78fbc5565bc;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;336;3875.824,202.3959;Inherit;False;Property;_power_clouds;power_clouds;16;0;Create;True;0;0;0;False;0;False;10;-2.44;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;335;4267.489,172.8928;Inherit;False;Property;_Multiply_clouds;Multiply_clouds;19;0;Create;True;0;0;0;False;0;False;3.36;0.2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;322;3939.069,633.1192;Inherit;True;Property;_Noise63;Noise63;22;0;Create;True;0;0;0;False;0;False;-1;ff023cd47bb523a4cbc64a19883de5d9;ff023cd47bb523a4cbc64a19883de5d9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;342;3272.772,881.3031;Inherit;False;Property;_Cloud_Movement;Cloud_Movement;24;0;Create;True;0;0;0;False;0;False;0.05,0.02;0.05,0.02;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.ColorNode;321;4814.513,-21.50508;Inherit;False;Property;_Cloud_Color;Cloud_Color;18;0;Create;True;0;0;0;False;0;False;1,1,1,0;0.3867925,0.3693408,0.2864454,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;306;3311.354,-274.789;Inherit;False;Property;_power_Water;power_Water;14;0;Create;True;0;0;0;False;0;False;10;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;305;3608.355,-639.789;Inherit;False;Property;_Multiply_Water;Multiply_Water;17;0;Create;True;0;0;0;False;0;False;3.36;4.26;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ClampOpNode;351;2605.423,-117.5108;Inherit;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;360;2462.438,18.66016;Inherit;False;Property;_SINmax;SIN max;26;0;Create;True;0;0;0;False;0;False;0;0.2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;167;7085.116,-522.919;Float;False;True;-1;2;ASEMaterialInspector;0;0;Standard;SH_MasterPlanet_Mercury;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;Back;0;False;;0;False;;False;0;False;;0;False;;False;0;Opaque;0.5;True;True;0;False;Opaque;;Geometry;All;12;all;True;True;True;True;0;False;;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;2;15;10;25;False;0.5;True;0;0;False;;0;False;;0;0;False;;0;False;;0;False;;0;False;;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;True;Relative;0;;-1;-1;-1;-1;0;False;0;0;False;;-1;0;False;;0;0;0;False;0.1;False;;0;False;;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT;0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
Node;AmplifyShaderEditor.FresnelNode;354;6095.904,306.9144;Inherit;False;Standard;WorldNormal;ViewDir;False;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
Node;AmplifyShaderEditor.LerpOp;358;6732.634,18.14529;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;356;6037.924,63.3944;Inherit;False;Property;_Fresnel_Color;Fresnel_Color;25;0;Create;True;0;0;0;False;0;False;1,0,0.7536311,0;0,0,0,0.7019608;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;359;6386.609,237.7376;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.LerpOp;320;5773.201,-580.1501;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.ColorNode;363;6075.49,-569.3439;Inherit;False;Property;_colornoise;color noise;28;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.Vector2Node;340;3456.555,58.91105;Inherit;False;Property;_Tiling_Clouds;Tiling_Clouds;12;0;Create;True;0;0;0;False;0;False;3,3;1.8,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;362;6094.213,-373.7193;Inherit;True;Property;_Noise97;Noise97;27;0;Create;True;0;0;0;False;0;False;-1;76b4933f64f42fc459c8d398900c61db;76b4933f64f42fc459c8d398900c61db;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;364;5849.464,-318.6102;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.LerpOp;361;6612.393,-651.2448;Inherit;False;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;366;6492.862,-328.564;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;367;6246.283,-157.7039;Inherit;False;Property;_NoiseMultiply;Noise Multiply;29;0;Create;True;0;0;0;False;0;False;0;1.11;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;365;5621.819,-237.5551;Inherit;False;Property;_Tiling_noise;Tiling_noise;13;0;Create;True;0;0;0;False;0;False;3,3;1.8,5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
WireConnection;351;2;360;0
WireConnection;167;0;361;0
