...
Shader "SH_SandTerrainFirstPass"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_107_0 = ( temp_output_51_0 * ( _Roughness + ( tex2D( _ShinyParticles, ( i.uv_texcoord / _ShinyParticleScale ) ).r * _ShinyParticleInfluence ) ) );
...
WireConnection;110;1;47;14
WireConnection;110;2;78;0
WireConnection;110;4;47;45
ASEEND*/
//CHKSM=7BAADA68C36227177C738C1433DDF7715C861216