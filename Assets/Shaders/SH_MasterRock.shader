...
Shader "SH_MasterRock"
{
	Properties
	{
		...
		[ASEBegin][Header(Global)]_Smoothness("Smoothness", Range( 0 , 1)) = 0
		...
		[ASEEnd]_AOIntensity("AOIntensity", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 _Sand;
			half4 _SandShade;
			half2 _TextureWorldScale;
			half _SunColorInfluence1;
			half _VariationIntensity;
			half _GrungeScale;
			half _HighlightIntensity;
			half _SandMaskHeight;
			half _SandShadeBias;
						 ...
						 ) : SV_Target
			{
				...
				half3 worldToObj43 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				#ifdef _OBJECTSPACE_ON
				half3 staticSwitch42 = worldToObj43;
				#else
				half3 staticSwitch42 = WorldPosition;
				#endif
				half lerpResult21 = lerp( tex2D( _Rock, ( (staticSwitch42).xy / _TextureWorldScale ) ).r , tex2D( _Rock, ( (staticSwitch42).zy / _TextureWorldScale ) ).r , WorldNormal.x);
				half3 lerpResult51 = lerp( (_RockColor0).rgb , (_RockColor1).rgb , lerpResult21);
				half4 transform101 = mul(GetObjectToWorldMatrix(),float4( 0,0,0,1 ));
				...
				#endif
				half3 worldToObj166 = mul( GetWorldToObjectMatrix(), float4( WorldPosition, 1 ) ).xyz;
				float4 triplanar45 = TriplanarSampling45( _Grunge, ( (worldToObj166).xyz / _GrungeScale ), WorldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
				#ifdef _USEUV_ON
				half staticSwitch158 = tex2D( _Grunge, ( IN.ase_texcoord7.xy / _GrungeScale ) ).r;
				#else
				half staticSwitch158 = triplanar45.x;
				#endif
				half temp_output_31_0 = ( 1.0 - IN.ase_color.g );
				half temp_output_50_0 = ( 1.0 - ( staticSwitch158 * temp_output_31_0 ) );
				half saferPower54 = abs( ( 1.0 - IN.ase_color.b ) );
				...
				half3 staticSwitch65 = ( staticSwitch103 * temp_output_50_0 );
				#endif
				half saferPower79 = abs( WorldNormal.y );
				half temp_output_38_0 = saturate( ( ( 1.0 - pow( saferPower79 , 2.0 ) ) * ( WorldPosition.y / _SandMaskHeight ) ) );
				...
				half fresnelNdotV128 = dot( WorldNormal, normalizeResult127 );
				...
				float3 BaseColor = staticSwitch73;
				float3 Normal = float3(0, 0, 1);
				float3 Emission = staticSwitch41;
				float3 Specular = 0.5;
				float Metallic = 0;
				float Smoothness = _Smoothness;
				float Occlusion = ( 1.0 - saturate( ( temp_output_31_0 * _AOIntensity ) ) );
				float Alpha = 1;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				#ifdef _USEUV_ON
				half staticSwitch158 = tex2D( _Grunge, ( IN.ase_texcoord3.xy / _GrungeScale ) ).r;
				#else
				half staticSwitch158 = triplanar45.x;
				#endif
				half temp_output_31_0 = ( 1.0 - IN.ase_color.g );
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;88;4258.147,-502.1713;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;89;4258.147,-502.1713;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;SH_MasterRock;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;0;638261291325682616;Built-in Fog;1;0;_FinalColorxAlpha;0;0;Meta Pass;1;0;Override Baked GI;0;638261379988024871;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;8;False;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;90;3572.81,-599.4445;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;91;3572.81,-599.4445;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;92;3572.81,-599.4445;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;93;3572.81,-599.4445;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;94;3572.81,-599.4445;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;95;3572.81,-599.4445;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;3;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.RangedFloatNode;30;391.4612,511.0916;Inherit;False;Property;_AOIntensity;AOIntensity;23;0;Create;True;0;0;0;False;0;False;0;0.69;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.StaticSwitch;73;3542.455,-605.9673;Inherit;False;Property;_SandMaskOn;SandMaskOn;7;0;Create;True;0;0;0;True;0;False;0;1;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.Vector2Node;24;-1356.09,-1248.422;Inherit;False;Property;_TextureWorldScale;TextureWorldScale;5;0;Create;True;0;0;0;False;0;False;1,1;17.78,3.12;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.ColorNode;9;-341.5219,-919.3012;Inherit;False;Property;_RockColor0;RockColor0;3;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.5377358,0.3089224,0.1200605,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;10;-328.8841,-758.818;Inherit;False;Property;_RockColor1;RockColor1;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.2941177,0.1098039,0.01176471,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;64;703.6863,92.85184;Inherit;False;Property;_HighlightIntensity;HighlightIntensity;22;0;Create;True;0;0;0;False;0;False;0;0.625;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;133;1064.565,-1071.163;Inherit;False;Property;_SandShade;SandShade;9;0;Create;True;0;0;0;False;0;False;0,0,0,0;0.7058824,0.3960784,0.2392157,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;134;1063.122,-1233.673;Inherit;False;Property;_Sand;Sand;8;0;Create;True;0;0;0;False;0;False;0,0,0,0;1,0.7416171,0.4685534,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StaticSwitch;103;781.6638,-499.134;Inherit;False;Property;_ColorVariation;ColorVariation;17;0;Create;True;0;0;0;False;0;False;0;1;1;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;37;1290.635,604.1499;Inherit;False;Property;_SandMaskHeight;SandMaskHeight;6;1;[Header];Create;True;1;Sand;0;0;True;0;False;1;9.02;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;66;3577.309,-289.3418;Inherit;False;Property;_Smoothness;Smoothness;0;1;[Header];Create;True;1;Global;0;0;False;0;False;0;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;56;-722.8834,410.6524;Inherit;False;Property;_GrungeScale;GrungeScale;19;0;Create;True;0;0;0;False;0;False;0;2.48;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-174.3104,-324.8015;Inherit;False;Property;_VariationIntensity;VariationIntensity;16;1;[Header];Create;True;1;Variation;0;0;True;0;False;0;0.08;0;1;0;1;FLOAT;0
...
WireConnection;89;4;66;0
WireConnection;89;5;32;0
...
ASEEND*/
//CHKSM=D2F47A42EE2A16C81D0312D9A218B2527DA52EB6