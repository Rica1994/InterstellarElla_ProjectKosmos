	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float gradientNoise7 = GradientNoise(( (transform101).xz / 100.0 ),0.0);
				...
				#endif
				float4 transform60 = mul(unity_WorldToObject,float4( worldPos , 0.0 ));
				float4 triplanar45 = TriplanarSampling45( _Grunge, ( (transform60).xyz / _GrungeScale ), WorldNormal, 1.0, float2( 1,1 ), 1.0, 0 );
				float temp_output_50_0 = ( 1.0 - ( triplanar45.x * ( 1.0 - IN.ase_color.g ) ) );
				float saferPower54 = abs( IN.ase_color.b );
				float3 temp_output_52_0 = ( staticSwitch103 + ( triplanar45.r * pow( saferPower54 , 2.0 ) * _HighlightIntensity ) );
...
Node;AmplifyShaderEditor.RangedFloatNode;30;391.4612,511.0916;Inherit;False;Property;_AOIntensity;AOIntensity;23;0;Create;True;0;0;0;False;0;False;0;1.47;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;69;2778.224,118.4433;Inherit;False;Property;_SunColorInfluence;SunColorInfluence;16;0;Create;True;1;Sand Layer;0;0;True;0;False;0.32;0.346;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StaticSwitch;103;781.6638,-499.134;Inherit;False;Property;_ColorVariation;ColorVariation;18;0;Create;True;0;0;0;False;0;False;0;1;0;True;;Toggle;2;Key0;Key1;Create;True;True;All;9;1;FLOAT3;0,0,0;False;0;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT3;0,0,0;False;5;FLOAT3;0,0,0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-174.3104,-324.8015;Inherit;False;Property;_VariationIntensity;VariationIntensity;17;1;[Header];Create;True;1;Variation;0;0;True;0;False;0;1;0;10;0;1;FLOAT;0
...
WireConnection;158;0;73;0
WireConnection;158;2;41;0
WireConnection;158;5;66;0
WireConnection;158;6;32;0
ASEEND*/
//CHKSM=D2B329B3B0AD3529B551A1B0FD00A496C237CB53