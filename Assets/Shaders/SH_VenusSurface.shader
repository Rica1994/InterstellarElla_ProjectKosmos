...
Shader "VenusSurface"
{
	Properties
	{
		...
		_MaskIntensity("MaskIntensity", Range( 0 , 10)) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_32_0 = ( tex2DNode21.r * temp_output_15_0 * _MaskIntensity );
			...
			float temp_output_16_0 = ( ( tex2DNode24.r + tex2DNode21.r ) * temp_output_15_0 * _MaskIntensity );
...
Node;AmplifyShaderEditor.RangedFloatNode;46;1947.574,-274.9101;Inherit;False;Property;_Roughness;Roughness;11;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;47;557.6662,395.6861;Inherit;False;Property;_MaskIntensity;MaskIntensity;12;0;Create;True;0;0;0;False;0;False;0;10;0;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2A2A6B1AB986313C2B45519E97BAA7075036D92D