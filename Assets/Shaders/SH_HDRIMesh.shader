...
Shader "HDRASpaceMeshShader"
{
	Properties
	{
		...
		[ASEBegin]_StarryTexturScale("StarryTexturScale", Float) = 1
		...
		[ASEEnd]_StarMaskOffset("StarMaskOffset", Float) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 _StarColor1;
			float _StarryTexturScale;
			float _PowerMask;
			float _StarMaskOffset;
			float _StarNoiseIntensityMask;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float mulTime36 = _TimeParameters.x * 0.01;
				float4 blendOpSrc21 = IN.ase_color;
				...
				float3 Color = ( saturate( 	max( blendOpSrc21, blendOpDest21 ) )).rgb;
				float Alpha = 1;
...
WireConnection;63;2;21;0
ASEEND*/
//CHKSM=60352806599FE90225B950172A8A0D9EB3489556