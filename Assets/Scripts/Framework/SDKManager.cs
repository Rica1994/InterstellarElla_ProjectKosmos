...
{
    public static event LoadCallback LoadedEvent;
    ...
    private static void HandleSDKEvent(string eventType, bool eventDetail)
    {
        Debug.Log($"SDK Event: {eventType}, Detail: {eventDetail}");
    }

    // Example callback method to handle loaded data.
    private static void OnDataLoaded(string stateId, string loadedData)
    {
